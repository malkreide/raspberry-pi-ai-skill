...
description: Raspberry Pi Projekte mit Edge AI. Nutze diesen Skill wenn der User (1) ein Pi-Projekt plant oder einen Bauplan mit Komponentenliste braucht, (2) Sensoren, Aktoren, HATs oder offizielles Zubehör integriert (Build HAT, Sense HAT, DAC, Monitor), (3) Edge AI deployt (Pi 4/5, Ollama, Hailo-NPU, AI Kit/HAT+, AI Camera IMX500), (4) Hardware oder Software systematisch debuggt, (5) einen Pi aufsetzt (Imager, SD/NVMe, headless, SSH, WLAN, Netzteil), (6) Raspberry Pi OS, apt, venv, Firmware oder Kameras nutzt (rpicam-apps, libcamera, Picamera2), (7) ein System konfiguriert (raspi-config, config.txt, Device Tree, dtoverlay, EEPROM), (8) mit dem Kernel arbeitet (Header, Module, DKMS, eigener Build, PREEMPT_RT), (9) aus der Ferne zugreift (SSH, VNC, Connect, rsync, Samba), (10) Schnittstellen nutzt (GPIO, I2C, SPI, UART, USB, DPI, RP1, PIO, PCIe, M.2 HAT+), (11) Mechanik, Kühlung oder Dauerbetrieb plant (Gehäuse, Watchdog, Übertakten, RTC), oder (12) Compute Module, Pi 400/500 oder Pico/RP2040/RP2350 einsetzt.
---
